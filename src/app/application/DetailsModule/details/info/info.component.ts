...
ngOnInit(): void {
  ...
  this.infoForm = new FormGroup({
      ...
      type : new FormControl(this.data.job.type),
      work : new FormControl(this.data.job.work),
      web : new FormControl(this.data.job.web),
      city : new FormControl(this.data.job.city),
      adress : new FormControl(this.data.job.adress),
      contact : new FormControl(this.data.job.contact),
      tel : new FormControl(this.data.job.tel),
